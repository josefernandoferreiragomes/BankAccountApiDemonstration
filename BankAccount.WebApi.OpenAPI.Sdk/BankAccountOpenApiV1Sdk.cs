...
namespace BankAccountOpenApiV1Sdk.Client
{
    ...
    public partial class BankAccountOpenApiSdk 
    {
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public BankAccountOpenApiSdk(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Customer>> ListAllAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/v1/Customer/list"
                    urlBuilder_.Append("api/v1/Customer/list");
        ...
        {
            return CreateAsync(firstName, lastName, email, phoneNumber, dateOfBirth, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<Customer> CreateAsync(string firstName, string lastName, string email, string phoneNumber, System.DateTimeOffset? dateOfBirth, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (dateOfBirth != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("dateOfBirth")).Append('=').Append(System.Uri.EscapeDataString(dateOfBirth.Value.ToString("s", System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    urlBuilder_.Length--;
        ...
        {
            return Test2Async(System.Threading.CancellationToken.None);
        }
